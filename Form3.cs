...
namespace WebcamDemo
{
    public partial class Form3 : BaseForm
    {
        ...
        {
            // Use centralized navigation to Form4
            NavigateToNextForm(FormType.Form3);
        }

        private void ButtonBack_Click(object? sender, EventArgs e)
        {
            // Use centralized navigation back to Form2
            NavigateToPreviousForm(FormType.Form3);
        }
        ...
        {
            base.OnFormLoad(e);
            labelStatus.Text = "สถานะ: Form 3 - เริ่มต้นอัตโนมัติ";
        }
